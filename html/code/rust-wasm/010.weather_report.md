...
<html>
  <head>
    ...
    <title>weather_report: nobundle</title>
    <link rel="stylesheet" media="screen" href="assets/stylesheets/bootstrap.css">
    <link rel="stylesheet" href="assets/stylesheets/weather_report_styles.css">
...
```js
import init from "../pkg/weather_report.js"
...
#[wasm_bindgen(module = "www/js/util.js")]
extern "C" {
...
`#[wasm_bindgen(module = "www/js/util.js")]`  We dont mix js files with Rust 
